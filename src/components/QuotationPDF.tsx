...
const QuotationPDF: React.FC<{ quotation: QuotationData }> = ({ quotation }) => {
  ...
  // Function to get PDF blob for Google Drive upload
  ...
  return (
    <div>
      ...
      <SaveToDriveButton
        fileName={`Quotation_${quotation.quotationNumber}_${formatDate(quotation.date)}.pdf`}
        getPdfBlob={getPdfBlob}
        folderName="Performa Quotations"
      />
    </div>
  );
};
